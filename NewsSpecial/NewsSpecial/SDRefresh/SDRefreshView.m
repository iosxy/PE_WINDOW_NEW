...
//        _stateIndicatorView.bounds = CGRectMake(0, 0, 15, 40);
       ...
       //加载导航栏背景图
        YLImageView* imageView = [[YLImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2.0 - 50,-25, 100, 100)];
        imageView.image = [YLGIFImage imageNamed:@"下拉刷新动态.gif"];
        _imageView = imageView;
        imageView.contentMode = UIViewContentModeScaleAspectFit;
        [self addSubview:imageView];
        
        self.backgroundColor=kColorControllerBackGround;
